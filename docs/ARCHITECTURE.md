...
src/store/                   sim.ts (the simulation store), scale.ts (the active scale, see Scale), lighting.ts ("always lit", see
                             Lighting), simSearch.ts (zod schema of the
...
src/features/solarSystem/    the 3D solar system: index.tsx (page), scene/ (Scene, SimClock, ScaleSync, simFrame, Markers, useThrottledSimTime),
                             ...
                             lighting/ (sunlightShader, bodyLighting, SunlitMaterial; see Lighting),
