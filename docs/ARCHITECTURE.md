...
src/sim/                     pure simulation code (no React, no three.js objects): units.ts, time.ts, kepler.ts, positions.ts, rotation.ts,
                             scale.ts (the scale engine, see Scale), index.ts (barrel, import from "@/sim");
